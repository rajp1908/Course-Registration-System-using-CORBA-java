...
public class Client {
	static computeTaskInterface obj1;
	static computeTaskInterface obj2;
	static computeTaskInterface obj3;
	...
	public static void addLog(String advisor,String student,String date,String arguments,String status){
		...
		String[] methods = new String[]{"addCourse","removeCourse","listCourseAvailability",
				"enrollCourse","dropCourse","getClassSchedule","swap"};
	...
	public static void main(String[] args){
		...
		try{
		     ...
		     obj1 = computeTaskInterfaceHelper.narrow(ncRef.resolve_str("COMP"));
		     obj2 = computeTaskInterfaceHelper.narrow(ncRef.resolve_str("SOEN"));
		     obj3 = computeTaskInterfaceHelper.narrow(ncRef.resolve_str("INSE"));
		} 
		catch (Exception e) {
			...
			switch(i){
				...
				case 6: arguments = "("+str+")";
						...
						if(isAdvisor)
							...
							addLog("none",str,date,arguments,status);
					break;
				case 7: System.out.print("Enter Old courseID: ");
						sc = new Scanner(System.in);
						cid = sc.nextLine();
						System.out.print("Enter new CourseID: ");
						sc = new Scanner(System.in);
						String newCid = sc.nextLine();
						arguments = "( "+str+ ", "+newCid+", "+cid+" )";
						if(sub.equals("COMP"))
							ans = obj1.swapCourse(str, newCid, cid);
						if(sub.equals("SOEN"))
							ans = obj2.swapCourse(str, newCid, cid);
						if(sub.equals("INSE"))
							ans = obj3.swapCourse(str, newCid, cid);
						if(ans.equals("enroll")) {
							System.out.println("Enrolled Successfully in "+newCid);
							status = "success";
						}
						if("limit".equals(ans)) {
							System.out.println("Can't take more than 3 courses");
							status = "unsuccessful";
						}
						if("cant".equals(ans)) {
							System.out.println("Can't take more than 2 courses of other Dept");
							status = "unsuccessful";
						}
						if("full".equals(ans)) {
							System.out.println("All seats are full");
						...
						if("notenroll".equals(ans)) {
							System.out.println("Not enrolled in "+cid+" course");
							status = "unsuccessful";
						}
						if("no".equals(ans)) {
							System.out.println("Not enrolled in "+cid+" course");
